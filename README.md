...
Patch 24
-Fixed Uk lend leases to Soviets not working after the 2nd soviet agreement.
-Time locked the host decision to end China war to jan 1940
-Uk focus to fortify Egypt now only gives 1 fortress and 4 forts in el-alamein (instead of 2 and 3).
-Increased the chance for Cas to be shot down in battle from anti air. This has been doubled and the reason behind this is in most battles Cas joins the battle and does damage and the battle ends before there is even a single chance for aa to do damage.
-Nerfed Tora Tora Tora, Port strike from 200% > 100%, Naval attack 25% > 10%, Naval targeting 25% > 10%, naval attack agility 25% > 10%
-Japan should declare war on France and Canada when they do strike west.
-Reduced Cas attack on some late game techs (by 1) and made it so 1941-42 cas airframes start with rocket 1 instead of rocket 2, Typhoon and thunderbolt (Also the IL-2) are the main 2 which in approximation means that they go from ~50 ground attack to ~42. The later techs will increase it to ~52 (tempest and thunderbolt upgrades)
-Increased the IC cost of Cas modules (2-8 IC increases)
-Increased naval bombing on tactical bombs by 1 for each level.
-Reduced material module now reduces Cas damage by -10%
-Fixed the research times of thunderbolt and mustang 1944 techs.
-Finland Winter war bonus changed to have 5% less core attack, 25% less cas damage reduction (from 50% to 25%), army movement speed of 10% removed.
-Finland Revanchism spirit changed: core attack from 15% to 5%, core defence from 5% to 10%
-Finland Sisu core attack from 10% to 5%, later on Sisu would give you -50% out of supply factor which is now -25% out of supply (reduced by 25%).
Collectively Finland has lost a good chunk of its core attack however core defence has gone up by a bit. This is to attempt to balance out that Finland gets good guns therefore reducing core attack values should bring it in line. It should also make it a bit easier for Soviet during winter war and make Finland less able to fight in continuation with the greater impact from lack of supply and reduced movement speed.
-Increased the Tough terrain state modifier in Murmansk region from -25% to -60% (this is to encourage soviets to hold there but also to encourage Finland to do the decisions to push in these regions.)
-Converting the light gun on light cruiser to medium gun now costs more than if you build the medium gun outright.
-Vichy France should get pacific and state of med spirits
-Bulgaria now starts with no grinding spirit (idk how i missed this for this long but also no one else told me breh)
-Pulled changes from TFB :
//
- Fixed a bug where Poland was unable to do Agrarian Reform if they got the Peasent Strike debuff
- Added a new option when Vichy asks for its land back to have the Germans tell Vichy they need to do it again later. Vichy then gets a decision they can click to re-send the event to Germany at a later date.
- Furthermore, the option to not give back Vichy its land no longer causes them to unify with Free France
- Modified the event that happens at the start of the game to also display the state of the game rules so everyone knows what they are set to. (Idea taken from PMFU)
- Added a new Game Rule that will make it so Assault Guns are only useable as Support Companies. This can be toggled on or off before game start.
- Support Company AG's require double the amount of AG's, and have had their terrain modifiers halved.
//
*WEEEE* *WOOOO* Warning I (Hotsky super cool guy 1 million) am currently in the process of moving hence why updates have been on the smaller scale (but also so I can concentrate on fixing previous implemented features as well balancing them) but it’s also likely that there may be no update next week as things on my end of in more crazed state of limbo, but I will try to make any fixes needed (TFB updates). I cannot say how long this will last as it has already taken a good chunk of time in the last few weeks i would expect it could continue to do so. However, I will still be able to look at the suggestion channel it may be a more delayed response on my end. TLDR: Currently moving places going to be busy, updates will be small if there will be updates in the coming weeks.

Patch 25
-Fixed Befriend Siam Foucus which will bypass if Siam is already in the faction.
-Siam Will now declare war on Canada and France in Strike West
-Recall volunteers now cost 100pp and 25cp
-Soviet Focus to send equipment to China now costs 5 civs for 140 days
-Added a ton of optimization changes (map graphics in, this is more hopeful that it will improve game speed, if it does not I will revert these changes.)
-Overhauled Soviet Merging aircraft designers, This is because it did not work half most the time so it has been changed so that you just get an idea with the bonuses (-10% cas cost ect)
-Added some Gui for construction in the construction tab to see construction speed modifiers for each building
-Tweaked UK and German fighters so stats are more linear (i.e Focke wulf has better stats than the BF109, I am planning on doing a large shake-up on air since at currently still on an alpha version.)
-Added two new focuses for South Africa which can be done after 1940 august which grants -35% build cost to tanks for 90 days at cost of 5 civs, later they can gain the same buff for 120 days at the cost of 5 civs from both South Africa and UK.
-Heavy cruisers now cost 3 in command limit.

Special forces changes (Alpha):
-Added unique special forces equipment that is a designer: Marine equipment, Mountaineer Equipment, Paratrooper Equipment, and Special Forces Equipment.
-These equipments are needed to create their respective divisions however special forces equipment is needed for a new unit: 'Elite Infantry'which is a cheaper special forces unit. (Arditi also uses special forces equipment.)
-In all Special forces have higher stats but are more expensive in resources and equipment. They can also be specialised for defence or attack, soft or hard attack.
-Special forces technology (the far right in the infantry tech tree) is now locked behind focuses. This will mean the special forces is capped for each nation until they focus on expanding. This focus will also enable recruiting Elite Infantry. Some Countries will be able to unlock this sooner than others. This is to try to keep the number of special forces down in the early game, this is where special forces are arguably the strongest as they don't scale as well. (There are a few other modules you can unlock later through techs, i.e better anti-tank, or better breakthrough modules, Better communications). The cost of special forces equipment is higher in resources but this is also dependent on what modules you put into it but its made more difficult to build since you require a unquie special forces equipment for respective special forces. To compensate for special forces being more expensive minor nations can get cheaper special forces through focuses typically the same focuses that unlock elite infantry.
-Nerfed some focuses/decisions that gave special forces attack by half, this is to try and balance it so they are not too strong.
-Given France more special forces equipment (Mountaineer equipment, this should help give France a leg up.)

Soviet Industry Changes (Alpha):
-Soviets now start with the 2nd 5 year Plan Mission. This mission now aims for Soviets to build in certain regions/states and after the mission completed, they will gain additional civs/resources/steel mills/infrastructure. This is limited to a certain amount in each region and is different what will give extra factories (North Russia requires only 3 civs in a state for it to apply while in Moscow region needs at least 4). Soviets have a year to do it. In total, this should be a good civ or resource bonus to the soviets at the expense that the factories are in less ideal locations (places that might get captured by axis or in it force soviets to build in states with less ideal construction speed.)
-Spread out half of the civ factories that you get from focuses to random states in europe, this may make it easier to get more factories.